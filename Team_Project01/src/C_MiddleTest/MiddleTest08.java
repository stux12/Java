...
public class MiddleTest08 extends MiddleTest07 {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MiddleTest08 frame = new MiddleTest08(MiddleCount);
	 ...
	 * Create the frame.
	 */
	public MiddleTest08(int middleCount) {
		super(middleCount);
		...
		button.setIcon(new ImageIcon(MiddleTest08.class.getResource("/image/Ghome.png")));
			...
			public void mouseClicked(MouseEvent e) {
				if (rdbtnNewRadioButton.isSelected() || rdbtnException.isSelected() || rdbtnThrows.isSelected()
					...
					if (rdbtnException.isSelected()) {
						...
						dispose();
						setVisible(false);
						new MiddleTest09(MiddleCount).setVisible(true);
					} else {
						dispose();
						setVisible(false);
						new MiddleTest09(MiddleCount).setVisible(true);
