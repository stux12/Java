...
public class MiddleTest03 extends MiddleTest02 {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MiddleTest03 frame = new MiddleTest03(MiddleCount);
	 ...
	 * Create the frame.
	 */
	public MiddleTest03(int middleCount) {
		super(middleCount);
		...
		rdbtnNewRadioButton = new JRadioButton("정적 클래스");
		...
		radioButton = new JRadioButton("익명 클래스");
		...
		JRadioButton radioButton_1 = new JRadioButton("인스턴스 클래스");
		...
		JRadioButton radioButton_2 = new JRadioButton("동적 클래스");
		radioButton_2.setFont(new Font("맑은 고딕", Font.PLAIN, 15));
		radioButton_2.setBackground(Color.GREEN);
		buttonGroup.add(radioButton_2);
		radioButton_2.setEnabled(true);

		radioButton_2.setBounds(80, 504, 550, 50);
		contentPane.add(radioButton_2);
		
		JLabel lblNewLabel = new JLabel("Q3. 내부 클래스의 종류로 틀린것은 ??");
		...
		button.setIcon(new ImageIcon(MiddleTest03.class.getResource("/image/Ghome.png")));
		...
		button_1.setIcon(new ImageIcon(MiddleTest03.class.getResource("/image/X.png")));
		...
		button_2.setIcon(new ImageIcon(MiddleTest03.class.getResource("/image/Right.png")));
			...
			public void mouseClicked(MouseEvent e) {
				if (rdbtnNewRadioButton.isSelected() || radioButton.isSelected() || radioButton_1.isSelected()
					...
					if (radioButton_2.isSelected()) {
						...
						dispose();
						setVisible(false);
						new MiddleTest04(MiddleCount).setVisible(true);
					} else {
						dispose();
						setVisible(false);
						new MiddleTest04(MiddleCount).setVisible(true);
