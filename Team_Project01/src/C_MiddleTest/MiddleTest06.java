...
public class MiddleTest06 extends MiddleTest05 {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MiddleTest06 frame = new MiddleTest06(MiddleCount);
	 ...
	 * Create the frame.
	 */
	public MiddleTest06(int middleCount) {
		super(middleCount);
		...
		button.setIcon(new ImageIcon(MiddleTest06.class.getResource("/image/Ghome.png")));
			...
			public void mouseClicked(MouseEvent e) {
				if (rdbtnNewRadioButton.isSelected() || rdbtnLifo.isSelected() || rdbtnFilo.isSelected()
					...
					if (rdbtnNewRadioButton.isSelected()) {
						...
						dispose();
						setVisible(false);
						new MiddleTest07(MiddleCount).setVisible(true);
					} else {
						dispose();
						setVisible(false);
						new MiddleTest07(MiddleCount).setVisible(true);
