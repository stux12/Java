...
public class MiddleTest10 extends JavaTestList {
	...
	private JRadioButton rdbtnBinarysearch;
	...
	public MiddleTest10() {
		...
		rdbtnBinarysearch = new JRadioButton("binarySearch() - 특정 객체의 위치를 순차 검색을 통해 해당 위치를 반환합니다.");
		rdbtnBinarysearch.setFont(new Font("맑은 고딕", Font.PLAIN, 15));
		...
		JRadioButton rdbtnCeil = new JRadioButton("trim() -  해당 문자열의 맨 앞, 맨 뒤에 포함된 모든 공백 문자를 제거합니다.");
		rdbtnCeil.setFont(new Font("맑은 고딕", Font.PLAIN, 15));
		...
		JRadioButton rdbtnConcat = new JRadioButton("concat() - 해당 문자열 뒤에 인수로 전달된 문자열을 추가한 새로운 문자열을 반환합니다.");
		rdbtnConcat.setFont(new Font("맑은 고딕", Font.PLAIN, 15));
		...
		button_2.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				if (rdbtnNewRadioButton.isSelected() || rdbtnBinarysearch.isSelected() || rdbtnCeil.isSelected()
		...
		button_2.setBounds(520, 620, 174, 52);
