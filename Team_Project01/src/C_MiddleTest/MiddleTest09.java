...
public class MiddleTest09 extends MiddleTest08 {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MiddleTest09 frame = new MiddleTest09(MiddleCount);
	 ...
	 * Create the frame.
	 */
	public MiddleTest09(int middleCount) {
		super(middleCount);
		...
		button.setIcon(new ImageIcon(MiddleTest09.class.getResource("/image/Ghome.png")));
			...
			public void mouseClicked(MouseEvent e) {
				if (rdbtnNewRadioButton.isSelected() || rdbtnParallelstream.isSelected() || radioButton_1.isSelected()
					...
					if (radioButton_1.isSelected()) {
						...
						dispose();
						setVisible(false);
						new MiddleTest10(MiddleCount).setVisible(true);
					} else {
						dispose();
						setVisible(false);
						new MiddleTest10(MiddleCount).setVisible(true);
