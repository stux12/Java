...
public class EasyTest05 extends EasyTest04 {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					EasyTest05 frame = new EasyTest05(EasyCount);
	 ...
	 * @param easyCount 
	 */
	public EasyTest05(int easyCount) {
		super(easyCount);
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				dispose();
				setVisible(false);
				new EasyTest06(EasyCount).setVisible(true);
			}
		});
		...
		button_5.setIcon(new ImageIcon(EasyTest05.class.getResource("/image/Yhome.png")));
