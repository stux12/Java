...
public class SortEx01 {
	...
	public static void main(String[] args) {
		/*
		다음배열을 소트하여 오름차순 및 내림차순으로 출력하시오.
			sort : key(기준), 차순(오름차순(ascending), 내림차순(descanding))
			내부 sort(memory sort): radix, selection, bubble, insertion, quick, shell...
			외부 sort				: disk(2-way merge sort, k-way..)
		*/
