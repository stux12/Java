...
public class IndexOf {
	...
	public static void main(String[] args) {
		...
		/*
		 * 책이름을 배열에 넣은후 JAVA책을 모두 검색하는 순차검색 프로그램을 작성하시오 (자바책이 있을 경우 결과) java Programming
		 * easy Java Programming Master of JAVA C# Language and java Oracle and
		 * Java-JDBC
		 */

		String[] bae = { "java Programming", "easy Java Programming", "Master of JAVA", "C# Language and java",
