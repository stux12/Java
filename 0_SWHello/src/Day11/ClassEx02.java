...
public class ClassEx02 {
	...
	public static void main(String[] args) {
		...
		/*
		 main()에
		 String pummok = "coffee:big:1500:jongro"; 이 있을때
		 cafe1 클래스를 사용하여 getter/setter 및 toString()등을
		 작성한후 toString()출력시 다음과 같이 출력하도록 프로그램을 작성하시오
		 (단, 커피명:사이즈:가격:지점을 의미하며
		 	cafe1클래스의 필드는 앞의 4개를 만들어 사용한다
