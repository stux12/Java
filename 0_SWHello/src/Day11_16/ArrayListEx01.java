...
public class ArrayListEx01 {
	...
	public static void main(String[] args) {
		...
		/*
		 * //Q3) 이제 여기에 collection을 적용시켜보기 arrayList arr3 를 만들어 처음에 판매한 날짜를 넣고 그다음부터
		 * 판매내용을 넣은 후 모두를 출력하시오 출력예) Mon Nov 16 19:59:44 KST 2020 상품이름은 우유이고 상품가격은
		 * 1000원입니다 상품이름은 빵이고 상품가격은 2000원입니다.
		 */

		/*
		 * 객체(사용자정의객체등)을 넣으려면 객체부터 만든다 SMarket s1 = new SMarket("우유", 2500); 컬렉션에 넣으려면
		 * new SMarket("우유", 2500); 를 만들고 add로 넣는다
		 */
...
//		 }
		...
		/*
		 * Q4) 이제 여기에 generic 을 적용 시켜보자는~~~ ArrayList <SMarket> arr5를 만들어 5개정도 판매상품을 넣은후
